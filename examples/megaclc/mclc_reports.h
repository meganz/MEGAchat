/**
 * @file
 * @brief This file contains some useful functions to make reports, e.g. a summary of a public chat, process and
 * organize a set of chat messages, etc.
 */
...
/**
 * @brief Writes to a file the contents of the chat with the given chat handle. The file is the one specified in the 
 * g_reviewPublicChatOutFile global variable.
 */
void reviewPublicChatLoadMessages(const c::MegaChatHandle chatid);

/**
 * @brief Extracts and organize relevant information inside msg and prints it to the cout and also to the
 * g_reviewPublicChatOutFile file.
 *
