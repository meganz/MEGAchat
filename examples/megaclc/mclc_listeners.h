...
struct CLCStateChange
{
    ...
    CLCStateChange(const CLCStateChange& o): state{o.state.load()}, stateHasChanged{o.stateHasChanged.load()} {}

    CLCStateChange(int s, bool sChange): state{s}, stateHasChanged{sChange} {}
};
...
public:
    ...
    megachat::MegaChatRequest* getMegaChatRequestPtr() const { return request.get(); }
