...
## Dependencies ##
 ...
 - Native WeebRTC stack from Chrome, see below for build instructions for it.  
...
## Building webrtc ##
First, create a directory where all stuff will go, and cd to it. All instructuon assume that the current directory is that one.  
