 ...
 * - Test4: enable auto-away with 5 seconds timeout
 *
 */
TEST_F(MegaChatApiTest, SetOnlineStatus)
{
    ...
    LOG_debug << "Test4: enable auto-away with 5 seconds timeout";
...
TEST_F(MegaChatApiTest, EditAndDeleteMessages)
{
    ...
    LOG_debug << "Test1: Send a message";
    TestChatRoomListener *chatroomListener = new TestChatRoomListener(this, megaChatApi, chatid);
 ...
 * - Test6: Change privileges to admin
 * - Test7: Changes privileges to read only
 * + Test8: Send message (error)
 * - Test9: Archive chatroom
 * - Test10: Send message (automatically unarchives)
...
//    ASSERT_TRUE(waitForResponse(chatJoined1)); --> account 1 haven't opened chat, won't receive callback
    ...
    // invite again --> error
    LOG_debug << "Test4: Invite same account (error)";
    ...
    LOG_debug << "Test6: Change privileges to admin";
    ...
    LOG_debug << "Test7: Changes privileges to read only";
    ...
    LOG_debug << "Test8: Send message (error)";
    ...
    LOG_debug << "Test10: Send message (automatically unarchives)";
...
TEST_F(MegaChatApiTest, Reactions)
{
    ...
    LOG_debug << "Test4: Check reactions in message (error)";
...
TEST_F(MegaChatApiTest, Attachment)
{
    ...
    LOG_debug << "Test7: Upload an image";
...
TEST_F(MegaChatApiTest, RetentionHistory)
{
    ...
    LOG_debug << "Test1: Select or create a group chat room";
    // Get a group chatroom with both users
    MegaChatHandle uh = user->getHandle();
    std::unique_ptr<MegaChatPeerList> peers(MegaChatPeerList::createInstance());
    peers->addPeer(uh, MegaChatPeerList::PRIV_STANDARD);
    ...
    //=========================================================//
    LOG_debug << "Test2: Set secondary account chat room privilege to READ ONLY";
...
TEST_F(MegaChatApiTest, ScheduledMeetings)
{
    ...
    //================================================================================//
    // Test2. A Updates a recurrent scheduled meeting with invalid TimeZone (Error)
    //================================================================================//
    ...
    //================================================================================//
    // Test3. A Updates previous recurrent scheduled meeting with valid data
    //================================================================================//
    ...
    //================================================================================//
    // Test4. A Updates scheduled meeting title along with chatroom title
    ...
    //================================================================================//
    // Test5. A Updates a scheduled meeting occurrence with invalid schedId (Error)
    //================================================================================//
    ...
    //================================================================================//
    // Test6. A Updates a scheduled meeting occurrence (new child sched meeting created)
    //================================================================================//
    ...
    //================================================================================//
    // Test7. A Fetch scheduled meetings occurrences chatroom
    //================================================================================//
    ...
    //================================================================================//
    // Test8. A Cancels previous scheduled meeting occurrence
    //================================================================================//
    ...
    //================================================================================//
    // Test9. A Sets negative offset at byMonthWeekDay
    //================================================================================//
    ...
    //================================================================================//
    // Test10. A Cancels entire series
    //================================================================================//
    ...
    //================================================================================//
    // Test11. A Deletes scheduled meeting with invalid schedId (Error)
    //================================================================================//
    ...
    //================================================================================//
    // Test12. A Deletes scheduled meeting
    //================================================================================//
