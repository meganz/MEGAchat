...
public:
    ...
    virtual promise::Promise<void> startCall(const karere::Id &chatid, karere::AvFlags avFlags, bool isGroup, const karere::Id &schedId, const bool notRinging, std::shared_ptr<std::string> unifiedKey = nullptr) = 0;
