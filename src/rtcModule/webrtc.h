...
public:
    ...
    virtual promise::Promise<void> startCall(karere::Id chatid, karere::AvFlags avFlags, bool isGroup, karere::Id schedId, int sfuId, std::shared_ptr<std::string> unifiedKey = nullptr) = 0;
