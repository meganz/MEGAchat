...
public:
    ...
    virtual void allowUsersFromWaitingRoom(const std::set<karere::Id>& users, const bool all) const = 0;
    virtual void kickUsersFromWaitingRoom(const std::set<karere::Id>& users) const = 0;
