...
CREATE TABLE scheduledMeetings(schedmeetingid int64 unique primary key, chatid int64, organizerid int64, parentSchedid int64, timezone text,
...
CREATE TABLE scheduledMeetingsOccurr(schedmeetingid int64, chatid int64, organizerid int64, parentSchedid int64, timezone text,
    start_date_time text, end_date_time text, title text, description text, attributes text, overrides text, cancelled tinyint default 0,
