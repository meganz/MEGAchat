CREATE TABLE sending(rowid integer primary key autoincrement, edits int64, edits_is_xid tynyint, chatid int64 not null, ts int, data blob, type tinyint);
...
CREATE TABLE history(idx int not null, chatid int64 not null, msgid int64, userid int64, ts int, data blob, edits int64, type tinyint default 0 not null, encrypted tinyint, UNIQUE(chatid, msgid));
