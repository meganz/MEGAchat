...
extern "C" KRLOGGER_DLLEXPORT const char* krLogLevelNames[krLogLevelLast+1] =
    {NULL, "ERROR", "WARN", "info", "verbose", "debug", "debug"};
                 ...
                 va_list aVaList)
{
    ...
    char* buf = statBuf;
    size_t bytesLogged = prependInfo(buf, LOGGER_SPRINTF_BUF_SIZE, prefix, krLogLevelNames[level]);
