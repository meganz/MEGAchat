...
public:
    ...
    enum { kPromiseType = 0x2e7294d1 };//shuld resemble 'retryhdl'
    /**
...
public:
     ...
     */
    RetryHandler(Func&& func, CancelFunc&& cancelFunc, unsigned attemptTimeout,
...
->decltype(func())
{
    auto self = new RetryHandler<Func, CancelFunc>(
