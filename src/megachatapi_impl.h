...
public:
    ...
    // Calls
    void startChatCall(MegaChatHandle chatid, bool adhoc, bool enableVideo = true,  bool enableAudio = true, MegaChatHandle schedId = MEGACHAT_INVALID_HANDLE, MegaChatRequestListener *listener = NULL);
