...
public:
    ...
    void setLimitsInCall(const MegaChatHandle chatid, const unsigned long long callDur, const unsigned long long numUsers, const unsigned long long numClientsPerUser, const unsigned long long numClients, MegaChatRequestListener* listener = nullptr);
