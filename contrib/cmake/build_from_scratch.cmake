...
set(_sdk_dir "${_chat_dir}/third-party/mega")

message(STATUS "Building for triplet ${_triplet} with chat ${_chat_dir} and SDK ${_sdk_dir}")

set (_3rdparty_dir "${_chat_dir}/../3rdparty_megachat")
...
set(_3rdparty_tool_common_args
    --ports "${_script_cwd}/preferred-ports-megachat.txt"
    --triplet ${_triplet}
    --sdkroot ${_sdk_dir}
)
...
if(WIN32)
    ...
    set(_build_dir "${_chat_dir}/build-${_triplet}")
    ...
    foreach(_config "Debug" "Release")
        set(_build_dir "${_chat_dir}/build-${_triplet}-${_config}")
        file(MAKE_DIRECTORY ${_build_dir})
